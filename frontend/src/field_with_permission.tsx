...
import { inputVariant, OptionType, PrivacyLevel } from '@app/data_context_global';
 ...
 */
export function FieldWithPermission({field, label, value, permission, setValue, fieldType = 'text'}:
    {field: string, label: string, value: string | null,
      permission: PrivacyLevel | undefined, setValue: Function, fieldType: LimitedInputType}) {
