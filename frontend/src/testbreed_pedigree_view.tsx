...
export function TestbreedPedigreView({
  chosenAncestors,
  generations,
}: {
  ...
  const [showCommonAncestors, setshowCommonAncestors] = React.useState(
    false as boolean
  );
  ...
  const res = React.useMemo(
    ...
    [genebanks, chosenAncestors, generations_input, showCommonAncestors]
  );
  ...
  return (
    <>
      <div className={style.netWorkConfiguration}>
        <Autocomplete
          className={style.generationsInput}
