            ...
            <>
              ...
              <Grid container direction="row">
                {linkedAuthenticators ? (
                  <>
                    {" "}
                    Länkade autentiseringstjänster:{" "}
                    {linkedAuthenticators.map((item) => (
                      <Button
                        onClick={() => unlinkExternal(item)}
                        key={item}
                        name={item}
                      >
                        {item}
              ...
              <Grid container direction="row">
                {!availableAuthenticators.filter(
                  (i) => !linkedAuthenticators.includes(i)
                ) ? (
                  ""
                ) : (
                  <>
                    ...
                    {availableAuthenticators
                      .filter((i) => !linkedAuthenticators.includes(i))
                      .map((item) => (
                        <Button
                          onClick={() => linkExternal(item)}
                          key={item}
                          name={item}
                        >
                          {item}
